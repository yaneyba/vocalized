...
| Script            | Description                                                    |
| ----------------- | -------------------------------------------------------------- |
| `npm run dev --workspace vocalized`     | Start Vite dev server with hot-module replacement. |
| `npm run build --workspace vocalized`   | Type-check and produce a production-ready build in `dist/`. |
| `npm run preview --workspace vocalized` | Serve the output of `dist/` for validation before deployment. |
